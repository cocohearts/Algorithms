...
class AVL_Tree():
    ...
    def recursive_delete(self,root,key,mode):
        ...
        if mode == "key":
            if root.val == key:
                ...
                if root.right:
                    if root.right.left or root.right.right:
                        root.right = self.recursive_delete(root.right,key,"key")
                    else:
                ...
                if root.left:
                    if root.left.left or root.left.right:
                        root.left = self.recursive_delete(root.left,key,"key")
                    else:
                        #root.left is a leaf
                        root.left = None
            ...
            if root.left:
                if root.left.left:
                    root.left = self.recursive_delete(root.left,key,"node")
                else:
                    global candidate_key
                    candidate_key = root.left.val
